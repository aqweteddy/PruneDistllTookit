...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int, default=2, required=True, help="Batch size for processing.")
    parser.add_argument("--max_length", type=int, default=4096, required=True, help="Maximum length of the tokenized input.")
